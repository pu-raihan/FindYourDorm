...
import com.example.fyd.RenterPhase.EditRenter;
import com.example.fyd.RenterPhase.MyProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                reference=database.getReference("renter").child(pro);
                reference.child("phone").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try {
                            ...
                            String t="tel:"+p;
                            phoneIntent.setData(Uri.parse(t));
                            if (ActivityCompat.checkSelfPermission(PublicProfile.this,
        ...
        reference.child(pro).addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PublicProfile.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
